...
def draw_shape(open_img,gray_img):
    ...
    str1 = '(' + str(center_x)+ ',' +str(center_y) +')' #把座标转化为字符串
    cv2.putText(src,str1,(center_x-50,center_y+40),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,0),2,cv2.LINE_AA)#绘制座标点位
